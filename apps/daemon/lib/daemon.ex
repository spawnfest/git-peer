defmodule GitPeer.Daemon do
  ...
  def request_review(%{requester: requester, ref: ref, users: user}) do
    Services.Review.request_review(%{requester: requester, ref: ref, users: user})
  end
  ...
  def review_response(%{requester: requester, ref: ref, reviewer: reviewer, review: review}) do
    Services.Review.review_response(%{requester: requester, ref: ref, reviewer: reviewer, review: review})
  end
